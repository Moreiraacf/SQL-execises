...
insert into funcionarios (nome, cpf, data_nascimento, endereco,
telefone, email, cargo, salario, data_admissao) values 
...
telefone, email, data_cadastro) values 
...
insert into pedidos (id_cliente, id_funcionario, id_produto, quantidade,
data_pedido, status_pedido) values 
